...
class BookController extends Controller
{
    ...
    public function allBooks(Request $request)
    {
        ...
        return view('admin.books.all',compact('books','categories','countries'));
    }
    ...
    //         ],
    //         [
    //             'categoryId'=>'التصنيف مطلوب',
    //             // 'subCategoryId'=>'required',
    //             'countryId'=>'يرجى اختيار الدوله ',
    //             'name'=>'ادخل عنوان الكتاب',
    //             'price'=>'ادخل سعر الكتاب',
    //             'date'=>'ادخل تاريخ اصدار الكتاب',
    //             'pages'=>'ادخل عدد الصفحات الكتاب',
    //             'licensing_authority'=>'ادخل جهة ترخيص الكتاب',
    //             'isbn_num'=>'ادخل رقم الكتاب',
    //             'license_number'=>'ادخل رقم ترخيص الكتاب',
    //             'license_year'=>'سنة ترخيص الكتاب',
    //             'description'=>'ادخل وصف الكتاب',
    //             'meta_key'=>'ادخل الكلامات الدلالية',
    //             // 'photo.required'=>' يرجي إختيار صورة jpeg,jpg,png,gif ',
    //             'file.required'=>' يرجي إختيار كتاب pdf ',
    ...
    public function viewBooke($story)
    {
        $categories=Category::all();
        $subcategory=SubCategory::all();
        $country=Country::all();
        $city=City::all();
        $book= Story::where('id',$story)->first();
        // dd($book);

        return view('admin.books.edit',compact('book','categories','subcategory','country','city'));
    }
