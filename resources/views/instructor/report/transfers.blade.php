...
<div class="content-header row">
	<div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">تقارير المبيعات</h3><br>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">سوف يتم تحويل المبلغ لك تلقائيا اذا وصل المبلغ ال 100 دولار او اكثر</h4>

                    <div class="card-body pb-0">
                            <form method="get" action="{{url('instructor/stories')}}">
                                <div class="row">
                                    <div class="col-md-5 ">
                                        <input name="from_date" type="text" class="form-control form-control-xl "  placeholder="من تاريخ">
                                    </div>
                                    <div class="col-md-5 ">
                                        <input name="to_date" type="text" class="form-control form-control-xl "  placeholder="إلي تاريخ">
                                    </div>
                                    <div class="col-md-2 ">
                                ...
                                <table class="table table-striped table-bordered keytable-integration">
                                    <thead>
                                        <tr>                                                    
                                            ...
                                            <th class="text-center">الإيراد بالدولار</th>
                                        </tr>
                                        </thead>
                                        <tbody>
