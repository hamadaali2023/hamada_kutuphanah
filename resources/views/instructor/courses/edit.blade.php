                                ...
                                @method('put')
			                                <div class="row form-row">
			                                    ...
			                                    <div class="form-group col-sm-6">
						                            ...
						                            <textarea id="projectinput9" rows="5" class="form-control" name="meta_key" placeholder="About Project">{{$course->meta_key}}</textarea>
						                            @error('meta_key')
			                                        	<span class="text-danger">{{$message}}</span>
			                                    	@enderror
						                        </div>
						                        <div class="form-group col-sm-6	">
						                            ...
						                            <textarea id="projectinput9" rows="5" class="form-control" name="meta_desc" placeholder="About Project">{{$course->meta_desc}}</textarea>
						                            @error('meta_desc')
			                                        	<span class="text-danger">{{$message}}</span>
			                                    	@enderror
						                        </div>
