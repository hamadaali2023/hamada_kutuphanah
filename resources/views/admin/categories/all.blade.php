		...
		<div class="content-header row">
			        ...
			        <div class="content-header-right col-md-6 col-12">
			          <div class="dropdown float-md-right">
			               <a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">أضافة تخصص</a>
			          </div>
			        </div>
											...
											@foreach ($categories as $_item)
												<tr>													
													<td class="text-center">
														<img class="avatar-img" src="{{asset('assets_admin/img/specialities/'.$_item->icon) }}" alt="Speciality" width="50" height="50">
													</td>
													<td class="text-center">
													...
													<td class="text-center">
														<div class="actions">
															...
															<!-- {{ url('categories/'.$_item->id).'/edit' }} -->
															<a class="btn btn-sm bg-success-light" href="{{route('categories.edit',$_item->id)}}"><i class="fe fe-pencil"></i> تعديل</a>
