...
@section('content')	
		...
		<div class="content-header row">
	        ...
	        <div class="dropdown float-md-right">
		        <a href="#Add_Specialities_details" data-toggle="modal" class="btn btn-primary float-right mt-2">إضافة منتج جديد</a>
		    </div>
		</div>
									...
									<div class="col-12 col-sm-6">
										<div class="form-group">
											<label>إرفاق صورة أو أكثر</label>
											 <input type="file" name="imagee[]" class="myfrm form-control">
				...
				<div class="modal-dialog modal-dialog-centered" role="document" >
					<div class="modal-content">
						...
						<div class="modal-body">
							 ...
							 <form  method="post" action="{{route('products.update','test')}}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
...
<script>
    $('#edit').on('show.bs.modal', function (event) {
      ...
      var titleid = button.data('title') 
      var descriptionid = button.data('description') 
     console.log(titleid);
     
      var cat_id = button.data('catid') 
      var modal = $(this)

      modal.find('.modal-body #titleid').val(titleid);
      modal.find('.modal-body #descriptionid').val(descriptionid);
